...
<?php
  ...
  $followed_array = DB::table('follows')->where('user_following', '=', Auth::id())->get();
  $followed_array = json_decode(json_encode($followed_array), true);
		...
		<ul class="list-group media-list media-list-stream">
          ...
          $allComments = json_decode(json_encode($allComments), true);
            ...
            <div class="media-body">
              ...
              <video controls>
                <source src="<? echo $post['file']; ?>" type="video/<? echo $post['file_type']; ?>">
              </video>
            ...
            <div class="media-body">
              ...
              <audio src="<? echo $post['file']; ?>" title="<? echo $post['title']; ?>">
                <source src="<? echo $post['file']; ?>" type="audio/<? echo $post['file_type']; ?>">
              </audio>
